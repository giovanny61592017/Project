...
Welcome to ``Project`` contributor's guide.
...
If you experience bugs or general issues with ``Project``, please have a look
...
You can help improve ``Project`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``Project`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``Project``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n Project python=3 six virtualenv pytest pytest-cov
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/Project.git
    cd Project
...
#. Install |pre-commit|_::
   ...
   ``Project`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/Project
.. _issue tracker: https://github.com/<USERNAME>/Project/issues
.. <-- end -->
